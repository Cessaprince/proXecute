...
import { BellDotIcon, HamburgerIcon, LucideBell, LucideBellDot, MenuIcon, SearchIcon, LucideHome, Folder, CheckSquare, BarChart2, Settings, HelpCircle, LogOut } from 'lucide-react'
...
const Navbar = () => {
    ...
    return (
        <div className="w-full max-lg:flex-col max-lg:flex max-lg:gap-[10px] h-[60px] max-lg:h-auto fixed top-0 left-0 z-10 px-[30px] max-lg:px-[10px] py-[10px] shadow-lg bg-white">
            ...
            {menuOpen && (
                <div className="lg:hidden w-full px-[5px] fixed inset-0 top-[60px] z-20 bg-white flex flex-col gap-[10px] overflow-y-auto">
                    {/* 1 */}
                    <NavLink
                        to='/dashboard'
                        end
